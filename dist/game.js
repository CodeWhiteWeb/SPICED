...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var require_main = __commonJS({
    "code/main.js"(exports) {
      ...
      scene("story", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story2", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story3", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story4", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story5", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story6", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story7", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story8", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story9", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("story10", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
      ...
      scene("starting", () => __async(exports, null, function* () {
        const background = add([
          sprite("bg"),
          pos(width() / 2, height() / 2),
          origin("center"),
